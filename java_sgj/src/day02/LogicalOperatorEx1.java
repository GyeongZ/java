...
public class LogicalOperatorEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * - 성적이 100이하이고, 성적이 90이상이면 A일때, 성적이 95 => true
		 * - 100이고, 90이다 A, 성적이 95 => 뭐가 A이고 B인지 판별할 수 없다 => 에러가 발생
		 * - 진리표
		 * A && B
		 * F && F => F
		 * F && T => F
		...
		/* 성적이 올바르지 않은지를 확인, 올바르지 않은 성적은 0미만, 100초과

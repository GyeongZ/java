...
public class OddEvenGameEx1 {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 3: //프로그램 종료 : 그냥 출력
				System.out.println("프로그램 종료");
				break;
				
			default: //잘못된 메뉴 선택: 그냥 출력
	...
	/* 기능 : 랜덤으로 숫자를 생성하고, 정수(홀/짝)을 입력받아
	...
	public static boolean newGame() {
		...
		System.out.println(user + " " + (r%2==0?"짝":"홀") + "입니다.");
		//판별
		return r % 2 == user;
	}
	
	/* 기능 : 승 횟수와 패 횟수가 주어지며 a승 b패로 출력하는 메서드

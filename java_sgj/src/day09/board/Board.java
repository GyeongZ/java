...
public class Board {
	//정보 : 게시일(일자), 제목, 내용, 작성자,조회수, 번호 등등(멤버변수)
	private int num, views;
	private String writer, title, contents, date ; //작성자
	...
	//기능 : 게시글 정보를 출력하는 기능(목록조회), 게시글 정보를 출력하는 기능(상세조회),
	//		getter와 setter, 게시글 수정 기능
	...
	public Board(int num, String writer, String title, String contents, String date) {
		this.num = num;
		this.writer = writer;
		this.title = title;
		this.contents = contents;

package kr.kh.servlet__test.controller;
...
import kr.kh.servlet__test.model.dao.BoardDAO;
import kr.kh.servlet__test.model.vo.BoardVO;


@WebServlet("/servlet__test/selectBoard")
public class SelectBoardServlet extends HttpServlet {
    ...
    public SelectBoardServlet() {
		String resource = "kr/kh/servlet__test/config/mybatis-config.xml";

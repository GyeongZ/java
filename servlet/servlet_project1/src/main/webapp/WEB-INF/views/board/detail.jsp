		...
		<c:when test="${board != null }">
			...
			<div >
				...
				<div class="mb-3 mt-3" clearfix>
					<button type="button" id="btnUp" data-state="1" class="btn btn-outline-danger col-5">추천</button>
					<button type="button" id="btnDown" data-state="-1" class="btn btn-outline-danger col-5 offset-2">비추천</button>
				</div>
			  	<div class="mb-3 mt-3">

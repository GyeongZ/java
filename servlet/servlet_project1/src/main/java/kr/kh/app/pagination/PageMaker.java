...
public class PageMaker {
	...
	// totalCount, dispageNum, perPageNum, perPageNum(cri)를 이용하여
	//totaldPage, startPage, prev, next를 계산하는 메서드
	public void calculate(){
		// 예시) 전체 게시글 : 131개, 한 페이지에 게시글이 10개까지 조회, 14페이지
		// 현재 페이지에 대한 최대 페이지번호
		// 현재 페이지가 4페이지이고, 한 페이지에 컨텐츠 개수가 10개, 한 페이지네이션의 페이지 개수 : 10개 일 때
